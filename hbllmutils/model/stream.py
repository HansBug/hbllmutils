...
class ResponseStream:
    ...
    def __init__(self, session, with_reasoning: bool = False,
        ...
        Example::
            ...
            >>> stream_with_reasoning = OpenAIResponseStream(session, with_reasoning=True)
    ...
    def _get_reasoning_content_from_chunk(self, chunk):
        raise NotImplementedError  # pragma: no cover

    def _get_content_from_chunk(self, chunk):
        raise NotImplementedError  # pragma: no cover
...
class OpenAIResponseStream(ResponseStream):
    def _get_reasoning_content_from_chunk(self, chunk):
        ...
        return getattr(delta, 'reasoning_content')
